...
export default function DemoWrapper() {
  ...
  return (
    <div style={{ display: "flex", height: "100vh", overflow: "hidden", background: "#f5f5f5", fontFamily: "'Outfit', system-ui, sans-serif", color: "#1a1a1a" }}>

      {/* ——— LEFT SIDEBAR ——— */}
      <aside style={{ width: 320, flexShrink: 0, background: "#ffffff", borderRight: "1px solid #e5e5e5", display: "flex", flexDirection: "column", position: "fixed", top: 0, left: 0, bottom: 0, zIndex: 10, overflowY: "auto" }}>
        {/* Prototype Label */}
        ...
        <div style={{ padding: "20px 24px 16px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div style={{ width: 44, height: 44, borderRadius: 12, background: accent, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Young Serif', serif", fontSize: 22, fontWeight: 700, color: "#fff" }}>
              {c.studio.logo}
            </div>
            <div>
              <div style={{ fontFamily: "'Young Serif', serif", fontSize: 18, fontWeight: 600, letterSpacing: "0.02em", color: "#111827" }}>{c.studio.name}</div>
      ...
      <main style={{ flex: 1, display: "flex", justifyContent: "center", alignItems: "flex-start", paddingTop: 32, paddingBottom: 32, marginLeft: 320, marginRight: 340, overflow: "hidden" }}>
        <div style={{ position: "relative" }}>
          ...
          <div style={{
            ...
            boxShadow: "0 0 0 1px rgba(0,0,0,.1), 0 20px 60px rgba(0,0,0,.15), 0 0 120px rgba(196,145,94,.04)"
          }}>
            {/* Notch */}
      ...
      {/* ——— RIGHT SIDEBAR ——— */}
      <aside style={{ width: 340, flexShrink: 0, background: "#ffffff", borderLeft: "1px solid #e5e5e5", position: "fixed", top: 0, right: 0, bottom: 0, overflowY: "auto", padding: "24px 20px" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div style={{ background: `linear-gradient(135deg, ${accent}18, ${accentDark}08)`, border: `1px solid ${accent}30`, borderRadius: 14, padding: "22px 18px", textAlign: "center" }}>
            <h3 style={{ fontFamily: "'Young Serif', serif", fontSize: 22, fontWeight: 600, color: "#111827", margin: "0 0 6px" }}>{c.cta.heading}</h3>
